...
### Changed
- Comorbidities tab
	> COM71 Diabetes codes updated to codelist RR51.
- Lab Results tab
...
- Codelists tab
   ...
   > 
 	> Added codelist RR51 - Diabetes (Y, N, TYPE I, TYPE II, TYPE UNKNOWN, TYPE OTHER). 'TYPE I' and 'TYPE II' restored to match the V4 codes, correcting the typo introduced in V5 as 'TYPE1' and 'TYPE2'
### Removed
- Diagnoses tab
